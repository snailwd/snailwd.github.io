...
main_image: "/assets/images/project-demo.jpg"
...
{% if page.main_image %}
  <img src="{{ page.main_image | relative_url }}" alt="{{ page.title }}" style="width: 100%; margin: 20px 0; border-radius: 4px;">
{% endif %}

{% if page.repo_url %}
  <a href="{{ page.repo_url }}" class="btn btn--primary" target="_blank">View Repository</a>
{% endif %}
